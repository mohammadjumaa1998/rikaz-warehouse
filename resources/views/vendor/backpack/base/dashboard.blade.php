...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header"><i class="fa fa-align-justify"></i> Items With Export Total And Import Total</div>
            <div class="card-body">
                ...
                <thead>
                    ...
                    <tbody>
                        @foreach ($items_with_count as $item)
                        ...
                        <tr>
                            ...
                            <td>{{$item->min}}</td>
                            <td>{{$item->qty}}</td>
                            <td>{{$item->customer->sum('qty')}}</td>
                        </tr>
                        @endforeach
                      
                    </tbody>
                </table>
                {{$items_with_count->appends(array_except(Request::query(), 'items_with_count'))->links();}}
